...
scene("game", () => {
    ...
    // Add player with original blue color
    const player = add([
        rect(50, 50),            
        pos(400, 500),           
        color(0, 0, 255),        
    ...
    // Keep player in bounds and handle power-up effects
    player.onUpdate(() => {
        // Boundary check
    ...
    const powerUpTypes = [
        ...
        { color: [255, 255, 255], type: "extraLife", duration: 1 }  // White extra life
    ];
    ...
    onCollide("player", "powerUp", (p, powerUp) => {
        ...
        if (type.type === "extraLife") {
            ...
            if (type.type === "shield") {
                ...
                player.use(color(255, 215, 0)); // Turn gold immediately
